...
[![Build Status](https://travis-ci.org/t-kougei-game-comp/05_stack.svg?branch=develop)](https://travis-ci.org/t-kougei-game-comp/05_stack)
...
スタックには10個のデータが積めるものとします。それ以上積もうとしてもデータは詰まれず、何も処理されれないものとします。
